...
**License & Attribution:**
- No license file included. Add a `LICENSE` file if you plan to publish publicly and want to specify reuse terms.


**Contact / Maintainer:**
- Add a short `MAINTAINER` note or GitHub profile link if you want to show who maintains the repository.


Enjoy — let me know if you want me to add `README.md` improvements, tests, or a benchmark script next.
